...
{
    //Representação do que é necessário para se cadastrar um aluno
    public class CreateStudentCommand : Notifiable, ICommand
    {
        ...
        public IList<CreateParentCommand> Parents { get; set; } = new List<CreateParentCommand>();
        ...
        public void Validate()
        {
            ...
            //validações sobre o estado
            .IsNotNullOrEmpty(StateName, "StateName", SharedMessages.InvalidState)
            .HasMinLen(StateName, 3, "StateName", string.Format(SharedMessages.MinLength, "Estado", 3))
            .HasMaxLen(StateName, 50, "StateName", string.Format(SharedMessages.MaxLength, "Estado", 50))
            //validações do CEP
